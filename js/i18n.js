...
export const translations = {
  ...
  ar: {
    ...
    'sec.contact':             'تواصل',
    'contact.tagline':         'هل لديك مشروع في ذهنك، أو تريد <em>التعاون</em> في شيء ذي معنى؟',
    'contact.note':            'أود النقاش حول التقنية الإسلامية وتطوير تطبيقات الجوّال ومنصات الويب المخصصة.',
